...
* **A/B testing, Multiarmed Bandits, Thompson Bootstrap Sampling** [notebook](AB%20Testing_ABntesting_MultiarmedBandits_ThompsonBootstrap.ipynb)
    ...
    * Database: AIDS clinical trial
      
* **PCA and Bayesian Optimization** [notebook](Breast%20Cancer%20Diagnostic%20Features.ipynb)
    ...
    * Database: Breast Cancer Wisconsin Diagnostic dataset
      
* **Time Series Forecasting** [notebook](Timeseries.ipynb)
    ...
    * Database: Kaggle pharma sales
      
* **Time Series Forecasting with Deep Learning** [notebook](Timeseries2.ipynb)
 ...
 * **Binary outcome Machine Learning classifier** [notebook](Classification.ipynb)
    ...
    * Database: UCI Heart Disease (Cleveland) dataset
